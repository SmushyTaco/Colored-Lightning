...
tasks {
    ...
    register<TaskPublishCurseForge>("publishCurseForge") {
        ...
        val file = upload(1158570, remapJar)
        file.displayName = "[${project.extra["minecraft_version"] as String}] Colored Lightning"
...
modrinth {
    ...
    projectId.set("colored-lightning")
    uploadFile.set(tasks.remapJar)
    gameVersions.addAll(project.extra["minecraft_version"] as String)
    versionName.set("[${project.extra["minecraft_version"] as String}] Colored Lightning")
    dependencies {
